...
imgModi = face_recognition.load_image_file('Images_Attendance/Esther.jpg')
imgModi = cv2.cvtColor(imgModi, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('Images_Attendance/Meenu.jpeg')
...
cv2.imshow('Esther', imgModi)
cv2.imshow('Meenu', imgTest)
cv2.waitKey(0)
